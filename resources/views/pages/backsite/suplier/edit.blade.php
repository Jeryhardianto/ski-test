                ...
                <div class="card-body">
                 <form action="{{ route('suplier.update', $suplier->id) }}" method="POST">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="kodesuplier" name="kodesuplier" class="form-control @if ($errors->has('kodesuplier'))is-invalid @endif" id="kodesuplier" placeholder="Kode barang" value="{{ old('kodesuplier', $suplier->kode_suplier) }}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="namasuplier" class="form-control @if ($errors->has('namasuplier'))is-invalid @endif " id="namasuplier" placeholder="Nama barang" value="{{ old('namasuplier', $suplier->nama_suplier) }}">
